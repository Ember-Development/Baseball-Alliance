        ...
        <section className="mb-20">
          ...
          <div className="rounded-3xl bg-gradient-to-br from-white via-blue-50/30 to-white p-16 text-center shadow-lg shadow-black/5 border border-white/60 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="aspect-video max-w-4xl mx-auto rounded-2xl overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 border-2 border-gray-300 flex items-center justify-center">
                <div className="text-center">
                  <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-[#163968]/10 mb-4">
                    <svg
                      className="w-10 h-10 text-[#163968]/40"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <p className="text-gray-400 font-medium">Video content coming soon</p>
                </div>
              </div>
            </div>
          </div>
